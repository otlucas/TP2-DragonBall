...
public class ContenedorPrincipal extends GridPane {
	...
	private ArrayList<Image> cargarIconos(){
		...
		Image image = new Image(Application.class.getResource("/vista/imagenes/Goku/gokuNormal.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image);
		Image image1 = new Image(Application.class.getResource("/vista/imagenes/Goku/Goku_Kaioken.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image1);
		Image image2 = new Image(Application.class.getResource("/vista/imagenes/Goku/Super_Saiyan_Goku.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image2);
		Image image3 = new Image(Application.class.getResource("/vista/imagenes/Gohan/Gohan_Normal.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image3);
		Image image4 = new Image(Application.class.getResource("/vista/imagenes/Gohan/Gohan_SuperS.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image4);
		Image image5 = new Image(Application.class.getResource("/vista/imagenes/Gohan/Gohan_SS2.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image5);
		Image image6 = new Image(Application.class.getResource("/vista/imagenes/piccolo/Piccolo_Normal.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image6);
		Image image7 = new Image(Application.class.getResource("/vista/imagenes/piccolo/Piccolo_primera.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image7);
		Image image8 = new Image(Application.class.getResource("/vista/imagenes/piccolo/Piccolo_Segunda.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image8);
		Image image9 = new Image(Application.class.getResource("/vista/imagenes/Cell/Cell_Primera.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image9);
		Image image10 = new Image(Application.class.getResource("/vista/imagenes/Cell/Cell_Semiperfecto.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image10);
		Image image11 = new Image(Application.class.getResource("/vista/imagenes/Cell/Cell_Perfecto.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image11);
		Image image12 = new Image(Application.class.getResource("/vista/imagenes/freezer/Freezer_primera.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image12);
		Image image13 = new Image(Application.class.getResource("/vista/imagenes/freezer/Freezer_segunda_forma.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image13);
		Image image14 = new Image(Application.class.getResource("/vista/imagenes/freezer/freezer_definitivo.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image14);
		Image image15 = new Image(Application.class.getResource("/vista/imagenes/MajinBoo/Majin_buu_Normal.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image15);
		Image image16 = new Image(Application.class.getResource("/vista/imagenes/MajinBoo/MajinBoo_Primera.png").toExternalForm(), 100, 100, true, true);
		this.iconos.add(image16);
		Image image17 = new Image(Application.class.getResource("/vista/imagenes/MajinBoo/MajinBoo_Ultima.png").toExternalForm(), 100, 100, true, true);
